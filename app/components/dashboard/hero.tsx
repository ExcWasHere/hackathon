            ...
            <div className="flex justify-between items-center mb-6">
              <div className="relative">
                <input 
                  type="text" 
                  placeholder="Cari..." 
                  className="pl-10 pr-4 py-2 rounded-lg border bg-white bg-opacity-50 border-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-100 focus:border-transparent"
                />
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  <img src="/adrian-schledorn-31aJKD2f9xs-unsplash.jpg" className="w-10 h-10 rounded-full object-cover border-2 border-teal-500"/>
            ...
            <div className="bg-gradient-to-br from-blue-800 to-blue-900 text-white p-6 rounded-xl shadow-lg">
              ...
              <div className="space-y-10">
                {[
                  ...
                  { day: 'Minggu', condition: 'Cerah' }
                ].map((forecast) => (
                  <div key={forecast.day} className="flex justify-between items-center bg-white/10 p-3 rounded-lg hover:bg-white/20 transition-colors duration-200">
